...
- **Agent-Only Access**: Designed exclusively for AI agents (humans should use `scripts/agent_tools/` directly)
...
agent/ (Interface Layer)
    ...
    │
    ▼
scripts/agent_tools/ (Implementation Layer)
```

**Key Principle**: `agent/` is a thin wrapper layer. All actual implementations live in `scripts/agent_tools/`.
