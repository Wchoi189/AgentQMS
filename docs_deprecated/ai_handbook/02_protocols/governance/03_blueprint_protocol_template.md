...
- ❌ Simple single-task items
- ❌ When format inappropriate
...
### **For AI Agents**
1. **Assess Appropriateness**: Determine if blueprint format is suitable
2. **Ask for Confirmation**: If uncertain, ask user before applying template
3. **Customize Content**: Replace placeholders with project-specific information
4. **Maintain Structure**: Keep all required sections and format
5. **Update Progress**: Regularly update progress tracker as work proceeds

### **For Project Managers**
1. **Review Structure**: Ensure blueprint covers all necessary aspects
2. **Validate Phases**: Check that phases and tasks are realistic
3. **Assess Risks**: Review risk mitigation strategies
4. **Monitor Progress**: Use progress tracker for status updates
5. **Update Protocols**: Refine based on project learnings

## Quality Checklist

### **Required Elements**
- [ ] Master prompt with autonomous agent definition
- [ ] Progress tracker with all required fields
- [ ] Implementation outline with phases and tasks
- [ ] Technical requirements checklist
- [ ] Success criteria validation
...
- [Implementation Plan Protocol](02_implementation_plan_protocol.md)
...
*This template enables systematic, autonomous execution of complex implementations with clear progress tracking and comprehensive project management.*
