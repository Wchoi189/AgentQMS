...
python agent_tools/audit/audit_generator.py generate \
...
python agent_tools/audit/audit_validator.py validate \
...
python agent_tools/audit/checklist_tool.py track \
    --checklist "docs/audit/checklist_discovery.md" \
    --item "Scan for broken dependencies" \
    --status "completed"

# Generate progress report
python agent_tools/audit/checklist_tool.py report \
    --audit-dir "docs/audit"
```
...
```python
from agent_tools.audit.audit_generator import init_audit, generate_document
from agent_tools.audit.audit_validator import validate_document, validate_audit
from agent_tools.audit.checklist_tool import generate_checklist, update_checklist_item
```
