...
from AgentQMS.toolkit.utils.paths import get_docs_dir
...
DOC_INDEX_PATH = get_docs_dir() / "ai_handbook" / "index.json"
    ...
    if args.list_context_bundles:
        if list_available_bundles is None:
            print(
                ...
                "Ensure AgentQMS.toolkit.core.context_bundle can be imported.",
                file=sys.stderr,
            )
            sys.exit(1)
