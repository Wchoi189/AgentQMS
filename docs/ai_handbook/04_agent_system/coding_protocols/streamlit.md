...
- Files go to `docs/artifacts/[type]s/` directory
...
- **Agent System**: `docs/ai_handbook/04_agent_system/system.md` (single source of truth)
...
7. **No files in project root** - Artifacts go to `docs/artifacts/[type]s/` with proper naming and frontmatter
