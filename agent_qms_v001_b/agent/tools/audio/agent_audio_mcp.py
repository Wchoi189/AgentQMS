...
from streamlit_app.utils.path_utils import get_path_resolver, setup_project_paths

setup_project_paths()
resolver = get_path_resolver()
project_root = resolver.project_root

# Import play_audio using path resolver
if resolver:
    try:
        play_audio_path = resolver.config.scripts_dir / "utilities" / "play_audio.py"
    except AttributeError:
        play_audio_path = project_root / "scripts" / "utilities" / "play_audio.py"
else:
    play_audio_path = project_root / "scripts" / "utilities" / "play_audio.py"
...
class AudioMCPServer:
    ...
    def __init__(self):
        ...
        # Use global project_root set at module level
