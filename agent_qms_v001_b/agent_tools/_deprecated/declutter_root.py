...
def relocate_lightning_logs() -> None:
    ...
    print(
        f"Found lightning_logs directory with {len(list(lightning_logs_dir.rglob('*')))} items"
    )
...
def relocate_wandb_offline_data() -> None:
